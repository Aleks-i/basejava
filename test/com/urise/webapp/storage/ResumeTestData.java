...
public class ResumeTestData {
    ...
    public static Resume getResume(String uuid, String fullName) {
        ...
        TEMPLATE_TEST_RESUME.addSection(SectionType.EXPERIENCE, new OrganizationSection(List.of(
                new Organization("javaops", "http://javaops.ru/", "Создание, организация и проведение Java онлайн проектов и стажировок.",
                        new Period(LocalDate.of(2013, 10, 1),
                                LocalDate.now(),
                                "Автор проекта.")),
                new Organization("wrike", "https://www.wrike.com/", "Проектирование и разработка онлайн" +
                ...
                new Organization("ritcenter", "http://ritcenter.ru/", "Организация процесса разработки" +
                        ...
                        new Period(LocalDate.of(2012, 4, 1),
                                ...
                                "Java архитектор")),
                new Organization("luxoft", "http://www.luxoft.ru/", "Участие в проекте Deutsche " +
                        ...
                        new Period(LocalDate.of(2010, 12, 1),
                                ...
                                "Ведущий программист")),
                new Organization("yota", "https://www.yota.ru/", "Дизайн и имплементация Java EE " +
                        ...
                        new Period(LocalDate.of(2008, 6, 1),
                                ...
                                "Ведущий специалист")),
                new Organization("enkata", "http://enkata.com/", "Реализация клиентской (Eclipse RCP) и " +
                        ...
                        new Period(LocalDate.of(2007, 3,1),
                                ...
                                "Разработчик ПО")),
                new Organization("siemens", "https://www.siemens.com/ru/ru/home.html", "Разработка информационной " +
                        ...
                        new Period(LocalDate.of(2005, 1, 1),
                                ...
                                "Разработчик ПО")),
                new Organization("alcatel", "http://www.alcatel.ru/", "Тестирование, отладка, " +
        ...
        TEMPLATE_TEST_RESUME.addSection(SectionType.EDUCATION, new OrganizationSection(List.of(
                new Organization("coursera", "https://www.coursera.org/course/progfun", null,
                ...
                new Organization("luxoft-training", "http://www.luxoft-training.ru/training/catalog/course.html?ID=22366",
                        null, new Period(                LocalDate.of(2011, 3, 1),
                        LocalDate.of(2011, 4, 1),
                        "Курс \"Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.\"")),
                new Organization("siemens", "http://www.siemens.ru/", null, new Period(
                        LocalDate.of(2005, 1, 1),
                        LocalDate.of(2005, 4, 1),
                        "3 месяца обучения мобильным IN сетям (Берлин)")),
                new Organization("alcatel", "http://www.alcatel.ru/", null, new Period(
                        LocalDate.of(1997, 9, 1),
                        LocalDate.of(1998, 3, 1),
                        "6 месяцев обучения цифровым телефонным сетям (Москва)")),
                new Organization("ifmo", "http://www.ifmo.ru/", null,
                ...
                new Organization("mipt", "http://www.school.mipt.ru/", null, new Period(
