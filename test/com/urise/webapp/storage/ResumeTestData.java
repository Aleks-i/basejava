...
public class ResumeTestData {
    ...
    public static final Resume RESUME_1 = new Resume(UUID_1, FULL_NAME_1);/*getResume(UUID_1, FULL_NAME_1);*/
    public static final Resume RESUME_2 = new Resume(UUID_2, FULL_NAME_2);/*getResume(UUID_2, FULL_NAME_2);*/
    public static final Resume RESUME_3 = new Resume(UUID_3, FULL_NAME_3);/*getResume(UUID_3, FULL_NAME_3);*/
    public static final Resume RESUME_4 = new Resume(UUID_4, FULL_NAME_4);/*getResume(UUID_4, FULL_NAME_4);*/
    public static final Resume RESUME_SAVED = new Resume(UUID_SAVED, FULL_NAME_SAVED);/*getResume(UUID_SAVED, FULL_NAME_SAVED);*/
    public static final Resume RESUME_UPDATED = new Resume(UUID_1, FULL_NAME_UPDATED);/*getResume(UUID_1, FULL_NAME_UPDATED);*/
