    ...
    <table cellpadding="2">
        ...
        <c:forEach items="${organization.positions}"
            ...
            <form method="post" action="organization" enctype="application/x-www-form-urlencoded">
                ...
                <input type="hidden" name="action" value="editEducationOrganization">
                <tr>
                    <td colspan="2">
                        <dl>
                ...
                <tr>
                    <td colspan="2">
                        <center>
                            <button type="submit">Сохранить изменения по образовательному учреждению и продолжить
                            </button>
                        </center>
                    </td>
                </tr>
...
<section>
    ...
    <table cellpadding="2">
        <form method="post" action="organization" enctype="application/x-www-form-urlencoded">
            <input type="hidden" name="uuid" value="${organization.uuid}">
            <input type="hidden" name="idOrganization" value="${organization.id}">
            <input type="hidden" name="action" value="newEducationPosition">
            <tr>
                <td colspan="2">
                    <dl>
...
<section>
    ...
    <form method="get" action="resume" enctype="application/x-www-form-urlencoded">
        <input type="hidden" name="uuid" value="${organization.uuid}">
        <center>
            <button type="submit"><a href="resume?uuid=${organization.uuid}&action=edit">Завершить редактирование</a>
            </button>
        </center>
    </form>
</section>
